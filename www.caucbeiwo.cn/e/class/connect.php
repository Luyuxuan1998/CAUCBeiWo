...
function page1($num,$line,$page_line,$start,$page,$search){
	...
	if($page<>0)
	{
		$toppage='<a class="page-numbers" href="'.$url.'=0'.$search.'">'.$fun_r['startpage'].'</a>';
		$pagepr=$page-1;
		$prepage='<a class="prev page-numbers" href="'.$url.'='.$pagepr.$search.'"><i class="fa fa-chevron-left"></i></a>&nbsp;&nbsp;';
	}
	//下一页
	if($page!=$totalpage-1)
	{
		$pagenex=$page+1;
		$nextpage='<a class="next page-numbers" href="'.$url.'='.$pagenex.$search.'"><i class="fa fa-chevron-right"></i></a>&nbsp;&nbsp;';
		$lastpage='<a class="page-numbers" href="'.$url.'='.($totalpage-1).$search.'">'.$fun_r['lastpage'].'</a>';
	}
	...
	for($i=$starti;$i<$totalpage&&$no<$page_line;$i++)
	{
		...
		{
			$is_1='<a class="page-numbers" href="'.$url.'='.$i.$search.'">';
			$is_2="</a>&nbsp;";
		}
		$pagenum=$i+1;
