...
<?php
require(ECMS_PATH.'e/member/moyu_cp004/memberspacedefault.php');
?>
    </ul>
  </div>
</nav>
...
<div class="row border-bottom">
  <nav class="navbar navbar-static-top  " role="navigation" style="margin-bottom: 0">
    ...
    <ul class="nav navbar-top-links navbar-right">
      ...
      <li class="dropdown"> <a class="dropdown-toggle count-info" href="UserInfo.php?userid=<?=$userid?>"> <i class="fa fa-graduation-cap"></i>用户资料</a> </li>
    </ul>
  </nav>
</div>
