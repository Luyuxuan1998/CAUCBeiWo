...
?>  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>商品名称*正则：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td height="22" valign="top"><strong>商品图片*正则：</strong><br>
      ( 
...
<input name="add[qz_onlinepath]" type="text" id="add[qz_onlinepath]" value="<?=stripSlashes($r[qz_onlinepath])?>">
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>购买价格*正则：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>库存*正则：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>商品简介*正则：</strong><br>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>商品介绍*正则：</strong><br>
