...
<tr><td width='25%' height=25 bgcolor='ffffff'>学（工）号*</td><td bgcolor='ffffff'>
<input name="number" type="text" id="number" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($addr[number]))?>" size="">
</td></tr>
...
<tr><td width='16%' height=25 bgcolor='ffffff'>微信</td><td bgcolor='ffffff'><input name="msn" type="text" id="msn" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($addr[msn]))?>">
</td></tr>
