...
<link rel="shortcut icon" type="image/x-icon" href="[!--news.url--]skin/ecms147/images/favicon.ico" />
<!--[if lt IE 9]>
    <script src="[!--news.url--]skin/ecms147/js/html5.js" type="text/javascript"></script>
    <![endif]-->
<link rel='stylesheet' id='javin-font-css'  href='[!--news.url--]skin/ecms147/css/font-awesome.min.css?ver=4.2.0' type='text/css' media='all' />
<link rel='stylesheet' id='javin-style-css'  href='[!--news.url--]skin/ecms147/css/style.css?ver=1' type='text/css' media='all' />
<script type='text/javascript' src='[!--news.url--]skin/ecms147/js/jquery.js?ver=1.11.1'></script>
<script type='text/javascript' src='[!--news.url--]skin/ecms147/js/jquery-migrate.min.js?ver=1.2.1'></script>
</head>
<body>
  ...
  <div class="content">
    <div class="nav" role="navigation">
      <ul id="nav-menu" class="nav-menu">
        ...
        <li class="signin-toggle"> <a href="[!--news.url--]e/member/cp/" class="user-signin"><i class="fa fa-user"></i></a> </li>
        <li class="home-logo"><a href="[!--news.url--]"><span class="text-replace">
          <?=$public_r[sitename]?>
          </span></a></li>
      </ul>
      <ul id="nav-list" class="nav-list">
        <li id="logo"><a href="[!--news.url--]"><span class="text-replace">
          <?=$public_r[sitename]?>
          </span></a></li>
        <li id="search1" role="search">
          <form onsubmit="return checkSearchForm()" method="post" name="searchform" id="searchform" action="[!--news.url--]e/search/index.php" >
...
<div id="container" class="container">
  <div class="content category centralnav">
    <div class="recommend top"> 
      <script src=[!--news.url--]d/js/acmsd/thea6.js></script></div>
    <div id="guide">
      <div class="group">
        <ul>
          ...
          <li class="sort"> <a class="current"><i class="fa fa-sort"></i>浏览排序<i class="fa fa-caret-down arrow"></i></a>
            <ul class="sub">
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=7&orderby=diggtop&line=16">喜欢最多</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=7&orderby=onclick&line=16">浏览最多</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=7&orderby=newstime&line=16">最新发布</a></li>
            </ul>
          </li>
          <li class="timeframe"> <a class="current"><i class="fa fa-clock-o"></i>时间排序<i class="fa fa-caret-down arrow"></i></a>
            <ul class="sub">
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=7&orderby=newstime&line=16">不限时间</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=7&starttime=<?=date("Y-m-d",strtotime("-7day"))?>&endtime=<?=date("Y-m-d")?>&line=16">一周内</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=7&starttime=<?=date("Y-m-d",strtotime("-1month"))?>&endtime=<?=date("Y-m-d")?>&line=16">一月内</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=7&starttime=<?=date("Y-m-d",strtotime("-12month"))?>&endtime=<?=date("Y-m-d")?>&line=16">一年内</a></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div id="primary" class="primary list">
      <div class="article" role="main">
        ...
        <nav class="navigation paging-navigation" role="navigation"  >
          <div class="pagination loop-pagination"> [!--show.listpage--]</div>
        </nav>
      </div>
      <div id="sidebar" class="sidebar-container" role="complementary">
        <div class="sidebar-inner">
          <aside class="widget new-comments">
            ...
            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('selfinfo',5,2,1,'','newstime DESC');
if($ecms_bq_sql){
...
?>
          ...
          <aside class="widget sidabar-recommend">
            <div class="box"><script src=[!--news.url--]d/js/acmsd/thea8.js></script></div>
          </aside>
          <aside class="widget new-comments">
...
?>
          ...
          <aside class="widget sidabar-recommend">
            <div class="box"><script src=[!--news.url--]d/js/acmsd/thea9.js></script></div>
          </aside>
          <aside class="widget sidabar-recommend">
            <div class="box"><script src=[!--news.url--]d/js/acmsd/thea10.js></script></div>
          </aside>
        </div>
      </div>
    </div>
...
<script type='text/javascript' src='[!--news.url--]skin/ecms147/js/idangerous.swiper.min.js?ver=20131205'></script> 
<script type='text/javascript' src='[!--news.url--]skin/ecms147/js/functions.min.js?ver=1.0'></script>
</body>
</html>