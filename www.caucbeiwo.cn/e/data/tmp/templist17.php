  ...
  <div class="content">
    <div class="nav" role="navigation">
      <ul id="nav-menu" class="nav-menu">
        ...
        <li class="home-logo"><a href="[!--news.url--]"><span class="text-replace"><?=$public_r[sitename]?></span></a></li>
      </ul>
      <ul id="nav-list" class="nav-list">
        <li id="logo"><a href="[!--news.url--]"><span class="text-replace"><?=$public_r[sitename]?></span></a></li>
...
<div id="container" class="container">
  <div class="content category centralnav">
      ...
      <div class="group">
        <ul>
          ...
          <li class="sort"> <a class="current"><i class="fa fa-sort"></i>浏览排序<i class="fa fa-caret-down arrow"></i></a>
            <ul class="sub">
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=11&orderby=diggtop&line=16">喜欢最多</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=11&orderby=onclick&line=16">浏览最多</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=11&orderby=newstime&line=16">最新发布</a></li>
            </ul>
          </li>
          <li class="timeframe"> <a class="current"><i class="fa fa-clock-o"></i>时间排序<i class="fa fa-caret-down arrow"></i></a>
            <ul class="sub">
            <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=11&orderby=newstime&line=16">不限时间</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=11&starttime=<?=date("Y-m-d",strtotime("-7day"))?>&endtime=<?=date("Y-m-d")?>&line=16">一周内</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=11&starttime=<?=date("Y-m-d",strtotime("-1month"))?>&endtime=<?=date("Y-m-d")?>&line=16">一月内</a></li>
              <li><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&tempid=11&starttime=<?=date("Y-m-d",strtotime("-12month"))?>&endtime=<?=date("Y-m-d")?>&line=16">一年内</a></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div class="recommend"> 
      <script src=[!--news.url--]d/js/acmsd/thea7.js></script> </div>
  </div>
</div>
<footer id="footer">
  <div class="content">
