...
<div id="container" class="container">
  <div class="sub-billboard billboard shopping">
    <div class="wrapper">
      <div class="inner">
        <h1>网店商城 精彩不停</h1>
        <p>Theme shop constantly exciting</p>
      </div>
    </div>
  </div>
...
if($islast[islast]==1){
?>
 <li><a href="[!--news.url--]<?=$class_r[$topbclassid][classpath]?>">全部</a></li>
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select classid,classname from {$dbtbpre}enewsclass where bclassid='$bclassid'  and showclass=0 order by myorder,classid desc",0,24,0);
if($ecms_bq_sql){
...
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select classid,classname from {$dbtbpre}enewsclass where bclassid='$nclassid'  and showclass=0 order by myorder,classid desc",0,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
